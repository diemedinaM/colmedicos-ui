...
export default function CreateCredit() {
  ...
  return (
    <section className="mx-auto p-8 bg-white rounded-lg shadow">
      ...
      {/* Documentos jurídicos - tabla de clientes */}
      ...
      {/* Documentos jurídicos - detalle de cliente */}
        ...
        <table className="min-w-full text-xs mb-4">
          ...
          <tbody>
            <tr className="bg-white">
              ...
              <td className="border border-gray-300 px-2 py-2 text-green-700 font-semibold">Vigente <span className="inline-block w-2 h-2 rounded-full bg-green-500 ml-1"></span></td>
              <td className="border border-gray-300 px-2 py-2 text-center">
                <span className="inline-flex gap-1">
                  <span title="Editar">✏️</span>
            ...
            <tr className="bg-gray-50">
              ...
              <td className="border border-gray-300 px-2 py-2 text-red-700 font-semibold">Vencido <span className="inline-block w-2 h-2 rounded-full bg-red-500 ml-1"></span></td>
              <td className="border border-gray-300 px-2 py-2 text-center">
                <span className="inline-flex gap-1">
                  <span title="Editar">✏️</span>
                  <span title="Eliminar">🗑️</span>
      ...
      {/* Registrar documentos jurídicos */}
      <div className="border border-gray-300 rounded p-4 bg-white">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-2 col-span-2">
            <label className="text-sm font-medium text-gray-700 required">Aplica Vencimiento</label>
            <div className="flex items-center gap-2">
              <input type="checkbox" className="w-5 h-5" />
              <span className="text-sm text-gray-600">Activa campos</span>
            </div>
          </div>
          <div className="flex flex-col gap-2">
